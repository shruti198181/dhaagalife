        ...
        <Row className='py-5'>
          ...
          <Col md={6}>
            ...
            <div style={{ paddingLeft: 40, scrollbarWidth: 'none' }} >
              ...
              <button style={{ width: '300px', marginTop: '10px', borderRadius: '20px', borderColor: 'red', backgroundColor: '#FFF3E0' }}>Add to Cart</button>
              <button className='btn btn-dark' style={{ width: '300px', marginTop: '10px' }}>BUY NOW
