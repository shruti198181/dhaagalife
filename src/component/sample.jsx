...
function Sample () {
    return(
        <div style={{ backgroundColor: '#FFF3E0',width:'100vw', padding: '40px 40px 100px' }}>
            <Container>
                <Row className="align-items-center g-0">
                    <Col md={6} className="text-md-center text-xs-start">
                    <p>Box Clutches</p>
                    <p>Garden of<br/>
                    ButterCups</p>
                    </Col>
                    <Col md={6} className=" p-0  text-md-center text-xs-start">
                    <img
       ...
       <Row>
        <Col md={6} className=" p-0 pt-sm-1 text-sm-start text-xs-start">
           ...
           <Col md={6} className='text-center mt-5 mt-md-5 text-xs-start'>
       ...
       <Row className='py-5'>
        <Col  md={6} className='text-center mt-5 text-xs-start'>
         <h1>Sun Bag</h1>
...
tassels and cowrie shells. This bag is a statement piece that is an exquisite addition to <br/>your bag collection. 
        ...
        <Col md={6} className='text-sm-center text-xs-start'>
